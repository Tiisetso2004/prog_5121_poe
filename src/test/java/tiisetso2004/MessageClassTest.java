...
public class MessageClassTest {
    ...
    @Test
    @DisplayName("Message ID Generator Test")
    void testMessageIDGenerator() {
        ...
        for (int i = 0; i < SAMPLE_SIZE; i++) {
            ...
            generatedIds[i] = Message.GenerateMessageID(ID_LENGTH);
    ...
    void testMessageHashGenerator() {
        String messageID = "1234567890", message = "Hello world!";
        int messageNum = 45;
        assertEquals("12:45:Helloworld!", Message.createMessageHash(messageID,messageNum,message));
    }
}